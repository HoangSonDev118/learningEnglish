...
export function ReviewSummary({ summary, onRestart }: Props) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      ...
      <p className="mt-2 text-zinc-500">Great work on today&apos;s review</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Reviewed", value: summary.reviewedCount, color: "text-zinc-900" },
                { label: "Again", value: summary.againCount, color: "text-red-600" },
                { label: "Hard", value: summary.hardCount, color: "text-orange-600" },
                { label: "Good", value: summary.goodCount, color: "text-blue-600" },
                { label: "Easy", value: summary.easyCount, color: "text-green-600" },
              ].map((item) => (
